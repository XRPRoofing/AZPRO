...
export default function sitemap(): MetadataRoute.Sitemap {
  const baseUrl = "https://azprocontractors.com";
  ...
  return [
    ...
    { url: `${baseUrl}/services/foam-roofing`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/services/tile-roofing`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/services/commercial-roofing`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
