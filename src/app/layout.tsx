...
function Header() {
  return (
    <header className="bg-white shadow-sm sticky top-0 z-50">
      ...
      <nav className="container-max px-4 py-1 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2">
          <Image src="/logo.jpg" alt="AZ Pro Contractors LLC" width={280} height={93} className="h-20 w-auto" priority />
        </Link>
